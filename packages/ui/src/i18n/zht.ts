...
export const dict = {
  ...
  "ui.sessionTurn.status.thinkingComplete": "思考完成",
  "ui.sessionTurn.status.completedThoughts": "已完成 {{count}} 個思考過程",
  "ui.sessionTurn.status.completedTools": "已完成 {{count}} 個工具呼叫",
